...
namespace GainCall.Web.Controllers
{
    public class SupportController : Controller
    {
        ...
        {
            //return System.Web.UI.WebControls.View(db.Supports.ToList());

            return View();// System.Web.UI.WebControls.View();
        }
        ...
        public ActionResult Create(Support support)
        {
            ...
            return View(); // System.Web.UI.WebControls.View(support);
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Support support = null;// db.Supports.Include(s => s.FileDetails).SingleOrDefault(x => x.SupportId == id);
            if (support == null)
            {
                return HttpNotFound();
            }
        ...
        public JsonResult DeleteFile(string id)
        {
            ...
            try
            {
                ...
                FileDetail fileDetail = null;// db.FileDetails.Find(guid);
                if (fileDetail == null)
                {
        ...
        public JsonResult Delete(int id)
        {
            try
            {
                Support support = null;// db.Supports.Find(id);
                if (support == null)
                {
                    Response.StatusCode = (int)HttpStatusCode.NotFound;
                    return Json(new { Result = "Error" });
